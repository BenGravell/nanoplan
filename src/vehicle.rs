...
/// Tightest steer the plant can execute, a 5 meter turning radius.
...
/// Rolling-resistance acceleration, m/s2.
pub(crate) const ROLLING_RESISTANCE_ACCEL: f64 = ROLLING_RESISTANCE_COEFF * GRAVITY_MS2;
