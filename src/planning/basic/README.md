...
It tries three lookahead distances at three traversal durations, extends each candidate along the centerline to fill the
requested horizon, and selects the lowest-cost feasible rollout.
