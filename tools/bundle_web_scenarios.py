...
compiled into every build, native and wasm, via include_str! in the viewer —
...
corpus generated by this repo. Do NOT stage nuPlan exports for a deployed bundle:
...
(the two removed files are already compiled in via scenarios/json/)
"""
